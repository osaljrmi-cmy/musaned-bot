...
from app.musaned.runtime_config import get_musaned_credentials
...
def login_to_musaned(headless: bool = True) -> str:
    runtime_username, runtime_password = get_musaned_credentials()

    username = runtime_username or os.getenv("MUSANED_USERNAME")
    password = runtime_password or os.getenv("MUSANED_PASSWORD")

    if not username or not password:
        raise RuntimeError("MUSANED_USERNAME or MUSANED_PASSWORD is not set")

    browser, context, page = launch_browser(headless=True)
